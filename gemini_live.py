"""
gemini_live.py — Adapted from gemini-live-genai-python-sdk/gemini_live.py
Source: https://github.com/google-gemini/gemini-live-api-examples

Changes from original:
  - Added system_instruction parameter to __init__ and start_session config
  - Added voice_name parameter to __init__ and start_session config
"""
...
class GeminiLive:
    ...
    Extended from the original to support configurable system_instruction and voice.
    """
                    ...
                    try:
                        while True:
                            async for response in session.receive():
                                ...
                                if response.go_away:
                                    logger.warning(f"GoAway from Gemini: {response.go_away}")
                                if response.session_resumption_update:
                                    logger.info(
                                        f"Session resumption: {response.session_resumption_update}"
                                    )
